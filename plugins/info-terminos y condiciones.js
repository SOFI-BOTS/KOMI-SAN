...
let Terminos = `
*_Toda la información que se mencione aquí no excluye a la Propietaria del Bot, y Propietarios Acredores al uso de KOMI-SAN_*
...
*https://github.com/SOFI-BOTS/KOMI-SAN*
...
*https://www.instagram.com/sofibots*
...
*https://paypal.me/Oficial*


*~ Muchas Gracias Por tomarte el tiempo en informate sobre komisan*
`.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/sofibots`, pp, 'https://github.com/SOFI-BOTS/KOMI-SAN', '𝐊𝐎𝐌𝐈 - 𝐒𝐀𝐍 ', null, null, [
